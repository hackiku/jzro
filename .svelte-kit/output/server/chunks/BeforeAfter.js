import { s as setContext, g as getContext, c as create_ssr_component, b as compute_rest_props, a as subscribe, d as spread, f as escape_object, h as escape_attribute_value, i as add_attribute, v as validate_component, j as createEventDispatcher } from "./ssr.js";
import { B as Button } from "./index2.js";
import "dequal";
import { o as omit, m as makeElement, d as disabledAttr, e as executeCallbacks, a as addMeltEventListener, k as kbd, s as styleToString, c as createElHelpers, b as cn } from "./utils.js";
...
const BeforeAfter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.value === void 0 && $$bindings.value && value !== void 0) $$bindings.value(value);
  return `  <div class="flex items-center space-x-2">${validate_component(Button, "Button").$$render($$result, { variant: value ? "outline" : "default" }, {}, {
    default: () => {
      return `Before`;
    }
    ...
    {},
    {}
  )} ${validate_component(Button, "Button").$$render($$result, { variant: value ? "default" : "outline" }, {}, {
    default: () => {
      return `After`;
    }
  })}</div>`;
