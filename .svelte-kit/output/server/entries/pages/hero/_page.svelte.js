...
import { p as physicsStore, P as Planet } from "../../../chunks/Planet.js";
const GravityLauncher = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `  <section class="absolute top-0 left-0 z-0 w-screen h-screen"><svg width="100vw" height="100vh" viewBox="0 0 100 100" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-0 left-0"><path${add_attribute("d", trajectoryPath, 0)} fill="none" stroke="#ff3d00" stroke-width="0.2" stroke-dasharray="2,2"></path></svg></section>`;
});
