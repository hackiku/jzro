...
<footer class="flex flex-col items-center justify-end w-full relative overflow-hidden">
  ...
  <div class="w-full px-12 md:pr-32 xl:pr-72 mb-20 flex justify-end space-x-4 z-20">
  ...
  <!-- <img src="ui/mcrn.svg" alt="MCRN flag" class="absolute left-[16vw] h-20 z-10"> -->
    ...
    <img src={flagSrc} alt="Flag" class="absolute
      left-[10vw] md:left-[38vh] xl:left-[40vh] h-20 z-50"
      on:mouseover={() => flagSrc = 'ui/ukraine.svg'} 
      on:mouseout={() => flagSrc = 'ui/mcrn.svg'}
  ...
  <!-- <img src="ui/mcrn.svg" alt="MCRN flag" class="absolute hover:opacity-20 h-20 z-10 
    left-[12vw] sm:left-[18vh] md:left-[28vh] xl:left-[40vh]"> -->
