...
const initialState = {
  velocity: 10,
  planets: [
    { id: 'cta', gravity: 14, isActive: false },
    { id: 'work', gravity: 60, isActive: false },
...
function updatePlanetGravity(id, newGravity) {
  physicsStore.update(state => {
      ...
      // Optionally recalculate trajectory here if needed
