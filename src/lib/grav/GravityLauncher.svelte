...
<section class="absolute top-0 left-0 z-0 opacity-60 w-screen h-screen">
  <svg width="100vw" height="100vh" viewBox="0 0 100 100" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-0 left-0">
    ...
    <path d={trajectoryPath} fill="none" stroke="#4EBCFE" stroke-width="0.2" stroke-dasharray="1,1"/>
  </svg>
  </section>
